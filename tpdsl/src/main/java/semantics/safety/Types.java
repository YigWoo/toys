...
public class Types extends TreeFilter {
    ...
    public final expr_return expr() throws RecognitionException {
        ...
        member_return member5 = null;

        arrayRef_return arrayRef6 = null;

        call_return call7 = null;

        binaryOps_return binaryOps8 = null;
