...
public class Gen extends TreeParser {
    ...
    public final classMember_return classMember() throws RecognitionException {
        ...
        varDeclaration_return varDeclaration1 = null;
    ...
    public final type_return type() throws RecognitionException {
        ...
        CommonTree ID8=null;
        primitiveType_return primitiveType7 = null;
    ...
    public final statement_return statement() throws RecognitionException {
        ...
        expression_return b = null;

        block_return block15 = null;

        varDeclaration_return varDeclaration16 = null;
    ...
    public final bop_return bop() throws RecognitionException {
        bop_return retval = new bop_return();
        retval.start = input.LT(1);
    ...
    public final eqop_return eqop() throws RecognitionException {
        eqop_return retval = new eqop_return();
        retval.start = input.LT(1);
